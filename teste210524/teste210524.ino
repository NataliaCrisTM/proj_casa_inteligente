...
int motorGaragem = 2;                 // Usa o pino digital 3 para o motor da Garagem
...
void setup(){
  ...
  servoGaragem.write(180);                    // Inicia com o portao fechado (170º)
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {
          ...
          {
            servoGaragem.write(100);
          }
          else{
            if(readString.indexOf("?portaoClose") > 0)
            {
            servoGaragem.write(180);
            }
          }
          ...
          if(readString.indexOf("?ledonGaragem") > 0)
          {
            ...
            if(readString.indexOf("?ledoffGaragem") > 0)
            {
          ...
          if(readString.indexOf("?ledonSala") > 0)
          {
            ...
            if(readString.indexOf("?ledoffSala") > 0)
            {
          ...
          if(readString.indexOf("?ledonVaranda") > 0)
          {
            ...
            if(readString.indexOf("?ledoffVaranda") > 0)
            {
          ...
          if(readString.indexOf("?ledonQuarto") > 0)
          {
            ...
            if(readString.indexOf("?ledoffQuarto") > 0)
            {
          ...
          if(readString.indexOf("?ledonBanheiro") > 0)
          {
            ...
            if(readString.indexOf("?ledoffBanheiro") > 0)
            {
          ...
          if(readString.indexOf("?ledonSotao") > 0)
          {
            ...
            if(readString.indexOf("?ledoffSotao") > 0)
            {
