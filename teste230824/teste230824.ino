...
int luzGaragem = 35;      // Usa o pino digital 9 para a luz da Garagem
int luzSala = 33;         // Usa o pino digital 8 para a luz da Sala
int luzVaranda = 34;      // Usa o pino digital 7 para a luz da Varanda
int luzQuarto = 31;       // Usa o pino digital 6 para a luz do Quarto
int luzBanheiro = 32;     // Usa o pino digital 5 para a luz do Banheiro
int luzSotao = 30;        // Usa o pino digital 4 para a luz do Sotão
int motorGaragem = 36;    // Usa o pino digital 2 para o motor da Garagem
int sensorPir = 29;       // Usa o pino digital 3 para o sensor PIR
int buzAlarme = 28;      // Usa o pino digital 12 para a buzina do Alarme
